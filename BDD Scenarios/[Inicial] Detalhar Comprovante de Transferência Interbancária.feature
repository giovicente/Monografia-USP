Cenário: Consultar comprovante de transferência interbancária (conta origem e destino pertencem à instituições diferentes)

    Dado que o funcionário da área de operações realizou a listagem de comprovantes (cenário "Consultar lista de comprovantes")
    E clicar em "Link para visualizar" em um comprovante de transferência interbancária
    ...
    | * Não se Aplica *       | tipo_pessoa                    | Alfanumérico           | 1                       |
    | CPF / CNPJ              | numero_documento               | Alfanumérico           | 18                      |
    | Instituição             | nome_insituicao_financeira     | Alfanumérico           | 256                     |
    ...
    | Finalidade              | finalidade_transferencia       | Alfanumérico           | 256                     |
